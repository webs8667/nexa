...
// Get product ID
if (!isset($_GET['id'])) {
    setFlashMessage('danger', 'ID produk tidak ditemukan!');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $db->prepare("UPDATE products SET product_name = ?, category = ?, description = ?, price = ?, unit = ?, min_order = ?, image_url = ?, stock_status = ?, is_featured = ?, is_active = ? WHERE id = ?");
            $stmt->execute(array($product_name, $category, $description, $price, $unit, $min_order, $image_url, $stock_status, $is_featured, $is_active, $id));
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="unit" name="unit" required>
                                            <option value="kg" <?php echo $_POST['unit'] == 'kg' ? 'selected' : ''; ?>>kg</option>
                                            <option value="ton" <?php echo $_POST['unit'] == 'ton' ? 'selected' : ''; ?>>ton</option>
                                            <option value="pcs" <?php echo $_POST['unit'] == 'pcs' ? 'selected' : ''; ?>>pcs</option>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="min_order" name="min_order" required
                                               value="<?php echo $_POST['min_order']; ?>">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="category" name="category" required>
                                        ...
                                        <option value="pertanian" <?php echo $_POST['category'] == 'pertanian' ? 'selected' : ''; ?>>Pertanian</option>
                                        <option value="kerajinan" <?php echo $_POST['category'] == 'kerajinan' ? 'selected' : ''; ?>>Kerajinan</option>
                                        <option value="perikanan" <?php echo $_POST['category'] == 'perikanan' ? 'selected' : ''; ?>>Perikanan</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="stock_status" name="stock_status">
                                        <option value="available" <?php echo $_POST['stock_status'] == 'available' ? 'selected' : ''; ?>>Available</option>
                                        <option value="limited" <?php echo $_POST['stock_status'] == 'limited' ? 'selected' : ''; ?>>Limited</option>
                                ...
                                <div class="alert alert-info">
                                    <small>
                                        ...
                                        Updated: <?php echo formatDate($_POST['updated_at']); ?>
                                    </small>
                                </div>
                            </div>
                        </div>
